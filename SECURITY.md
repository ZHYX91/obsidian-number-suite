...
The highest-priority issues are unintended file modification, cleanup false positives, stale-preview writes, batch rollback failure, and source-marker interoperability problems.
